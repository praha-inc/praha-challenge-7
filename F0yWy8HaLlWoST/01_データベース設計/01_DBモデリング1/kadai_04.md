...
// 今回の例では注文IDが'11EDDC0217FBB916A8CF0242AC160002'のもの

SELECT
	SUM(M_SUSHI_MENUS.price * (1 - IFNULL(M_ITEM_COUPONS.discount_rate, 0) / 100) * T_ORDER_DETAILS.count - IFNULL(M_ITEM_COUPONS.discount_amount, 0)) 
		+ SUM(M_SET_MENUS.price * (1 - IFNULL(M_ITEM_COUPONS.discount_rate, 0) / 100) * T_ORDER_DETAILS.count - IFNULL(M_ITEM_COUPONS.discount_amount, 0))
    ...
    WHERE T_ORDERS.order_id = UNHEX('11EDDC0217FBB916A8CF0242AC160002');
```